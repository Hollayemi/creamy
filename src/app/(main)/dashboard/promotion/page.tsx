  ...
  return (
    <div className="flex flex-col gap-6 p-2">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="dark:text-primary text-2xl font-semibold text-gray-900">Promotions</h1>
          ...
          <TableHeader>
            <TableRow className="border-muted bg-muted text-muted-foreground">
              <TableHead className="w-12">
                <Checkbox checked={selectedRows.length === promotions.length} onCheckedChange={toggleAllRows} />
              </TableHead>
