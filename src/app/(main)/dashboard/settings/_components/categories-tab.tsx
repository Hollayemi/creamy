...
export default function CategoriesTab() {
  ...
  if (isLoading) {
    return <div className="flex h-64 items-center justify-center">Loading categories...</div>;
  }
            ...
            {categories.length === 0 ? (
              ...
              categories.map((category) => (
                <TableRow key={category._id}>
                  <TableCell>
                    {category.icon ? (
                      <img src={category.icon} alt={category.name} className="h-10 w-10 rounded object-cover" />
                    ) : (
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g., Electronics" />
            </div>
              ...
              <div className="flex items-center gap-4">
                {iconPreview ? (
                  <div className="relative">
                    <img src={iconPreview} alt="Preview" className="h-20 w-20 rounded object-cover" />
                    <Button
                      type="button"
                      variant="destructive"
                      size="icon"
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mt-1 text-xs">Max 5MB, JPG/PNG/GIF</p>
                </div>
              </div>
            </div>
          </div>
