    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-muted-foreground text-sm font-medium">Total Sent</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-muted-foreground text-sm font-medium">Delivered</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{stats.totalDelivered.toLocaleString()}</div>
              <p className="text-muted-foreground mt-1 text-xs">{stats.deliveryRate.toFixed(1)}% delivery rate</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-muted-foreground text-sm font-medium">Clicked</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{stats.totalClicked.toLocaleString()}</div>
              <p className="text-muted-foreground mt-1 text-xs">{stats.clickRate.toFixed(1)}% click rate</p>
            </CardContent>
          </Card>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Send targeted push notifications to your users</p>
        </div>
              ...
              {notifications.length === 0 ? (
                ...
                notifications.map((notification) => (
                  <TableRow key={notification._id}>
                    ...
                    <TableCell>
                      {notification.scheduleType === "scheduled" && notification.scheduledAt ? (
                    ...
                    <TableCell>
                      <div className="text-sm">
                        ...
                        <p className="text-muted-foreground text-xs">{notification.createdByName}</p>
                      </div>
                    </TableCell>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {notification.status === "draft" && (
                            <>
                              ...
                              <DropdownMenuItem onClick={() => handleSendNow(notification._id)} disabled={isSending}>
