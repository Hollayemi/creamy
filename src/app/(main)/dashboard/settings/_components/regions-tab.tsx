...
export default function RegionsTab() {
  ...
  const handleOpenDialog = (region?: Region) => {
    if (region) {
      ...
      setLatitude(region.coordinate.coordinates[0]);
      setLongitude(region.coordinate.coordinates[1]);
    } else {
      resetForm();
    }
  ...
  if (isLoading) {
    return <div className="flex h-64 items-center justify-center">Loading regions...</div>;
  }
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Manage delivery regions and locations</p>
        </div>
                ...
                <TableRow key={region._id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => openDeleteDialog(region._id)}>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-muted-foreground text-xs">Use lowercase with hyphens (e.g., lagos-mainland)</p>
            </div>
