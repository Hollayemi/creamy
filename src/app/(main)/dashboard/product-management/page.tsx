                            ...
                            <TableRow key={product._id} className="hover:bg-gray-50">
                                ...
                                <TableCell>
                                    <div className="flex items-center gap-1">
                                        <button className="rounded-full p-1.5 text-purple-600 hover:bg-purple-50">
                                            <Eye className="h-4 w-4" />
                                        </button>
                                        <button className="rounded-full p-1.5 text-orange-600 hover:bg-orange-50">
                                            <Pencil className="h-4 w-4" />
                                        </button>
                                        <button className="rounded-full p-1.5 text-red-600 hover:bg-red-50">
