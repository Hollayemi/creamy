...
const ProductPreviewPage = ({ params }: any) => {
    const myParams = use(params) as any
    const router = useRouter();
    const productId = myParams?.id //"6924f6b281b1e6feb92992e0"
    ...
    const handleDuplicate = () => {
        router.push(`/dashboard/product-management/create?duplicate=${productId}`);
    };
