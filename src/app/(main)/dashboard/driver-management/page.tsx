    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-4">Loading drivers...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage delivery personnel and their onboarding status</p>
        </div>
                ...
                <TableRow key={driver._id}>
                  <TableCell>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleSelectDriver(driver._id, checked as boolean)}
                    />
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-56">
                        ...
                        <DropdownMenuItem onClick={() => handleSuspend(driver)} className="text-orange-600">
                          <Clock className="mr-2 h-4 w-4" />
                          Suspend Account
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleDisable(driver)} className="text-red-600">
      ...
      {selectedDriver && (
        <>
          ...
          <DisableDriverDialog
            ...
            driver={selectedDriver}
          />
          <VerifyDriverDialog open={isVerifyDialogOpen} onOpenChange={setIsVerifyDialogOpen} driver={selectedDriver} />
        </>
      )}
    </div>
  );
