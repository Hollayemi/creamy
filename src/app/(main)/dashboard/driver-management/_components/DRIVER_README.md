...
- ✅ **Document Upload** - Profile photo and driver&apos;slicense
...
GET    /api/v1/drivers/:id/activity-logs  # Get driver&apos;slogs
```
...
```json
{
  "reason": "Incomplete documentation - driver&apos;slicense expired"
}
```
...
- Accept driver&apos;slicense photo (max 5MB)
