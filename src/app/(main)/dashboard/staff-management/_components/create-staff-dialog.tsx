          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <DialogDescription className="mt-2">
                Add a new team member to the GoKart Admin system. Assign their role, set their permissions, and define
                their access region.
              </DialogDescription>
            </div>
          </div>
        ...
        {step === 1 ? (
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              ...
              <div className="gap-4">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="region" className="w-full bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button onClick={handleNext}>{manualPermissions ? "Next" : "Finish"}</Button>
            </div>
          </div>
        ) : (
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-2 rounded-lg bg-purple-50 p-4">
                  <p className="font-medium text-purple-900">{selectedRole?.displayName || selectedRole?.name}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="backToManual" className="cursor-pointer font-normal">
