...
export default function ResetPasswordDialog({ open, onOpenChange, staff }: ResetPasswordDialogProps) {
      ...
      <Dialog open={open && !showConfirmation} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Generate a new temporary password for {staff.fullName}</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
                ...
                <p className="mt-1 font-semibold">{staff.fullName}</p>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="notifyUser" className="cursor-pointer font-normal">
              ...
              <>
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="flex-1 rounded border bg-white px-3 py-2 font-mono text-sm">{newPassword}</code>
                ...
                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3">
                  <p className="text-xs text-yellow-800">
                    ⚠️ Make sure to securely share this password with the user. This password will not be shown again.
                  </p>
                </div>
              </>
            )}
            ...
            {notifyUser && (
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                <p className="text-sm text-green-800">
                  ✓ An email has been sent to {staff.email} with the new temporary password and instructions.
                </p>
              </div>
            )}
          </div>
