...
export default function StaffManagementPage() {
  ...
  return (
    <div className="space-y-6 p-6">
                ...
                <TableRow key={member._id}>
                  <TableCell>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleSelectStaff(member._id, checked as boolean)}
                    />
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>{format(new Date(member.joinedDate), "dd MMM yyyy - hh:mm a")}</TableCell>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-56">
                        ...
                        <DropdownMenuItem onClick={() => handleSuspendAccount(member)} className="text-orange-600">
                          <Clock className="mr-2 h-4 w-4" />
                          {member.status === "suspended" ? "Unsuspend Account" : "Suspend Account"}
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleDisableAccount(member)} className="text-red-600">
      ...
      {selectedStaff && (
        <>
          <EditStaffDialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen} staff={selectedStaff} />
          <ActivityLogsDrawer
