  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white dark:bg-gray-900 p-4">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-4 bottom-1/4 h-32 w-32 animate-pulse rounded-full bg-cyan-500/30 blur-3xl" />
        <div className="absolute top-1/2 left-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-blue-500/20 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-2xl">
          ...
          {step === "credentials" && (
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <a href="/auth/forgot-password" className="font-medium text-purple-600 hover:text-purple-700">
                  Forgot Password?
                </a>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <Label className="block text-center text-sm font-medium text-gray-700">Enter OTP Code</Label>
                  <div className="flex justify-center">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <button onClick={handleResendOtp} className="font-medium text-purple-600 hover:text-purple-700">
                      Resend OTP
                    </button>
                  </p>
                </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-600">
            <p>©{new Date().getFullYear()} GoKart Admin Dashboard</p>
          </div>
        </div>
      </div>
    </div>
