...
export const staffApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    // ============ ACCOUNT ACTIONS ============
    suspendAccount: builder.mutation<BaseResponse, { id: string; data: SuspendAccountInput }>({
      query: ({ id, data }) => ({
    ...
    disableAccount: builder.mutation<BaseResponse, { id: string; data: DisableAccountInput }>({
      query: ({ id, data }) => ({
    ...
    updateStaffRole: builder.mutation<BaseResponse<Staff>, { id: string; roleId: string; permissions?: string[] }>({
