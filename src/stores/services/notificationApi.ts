...
export const notificationApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getAllNotifications: builder.query<
      BaseResponse<pushNotificationResponse>,
    ...
    createNotification: builder.mutation<BaseResponse<PushNotification>, FormData>({
      query: (formData) => ({
        url: "/push-notifications",
        method: "POST",
        data: formData,
    ...
    updateNotification: builder.mutation<BaseResponse<PushNotification>, { id: string; formData: FormData }>({
      query: ({ id, formData }) => ({
        url: `/push-notifications/${id}`,
        method: "PUT",
        data: formData,
      ...
      invalidatesTags: (result, error, { id }) => [{ type: "PushNotifications", id }, "PushNotifications"],
    }),
    ...
    testNotification: builder.mutation<BaseResponse, CreateNotificationInput>({
      query: (data) => ({
